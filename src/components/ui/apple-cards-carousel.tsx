    ...
    <>
        ...
        {open && (
          <div className='fixed inset-0 h-screen z-50 overflow-auto'>
            ...
            <motion.div
              ...
              className='max-w-5xl mx-auto bg-white dark:bg-neutral-900 h-fit  z-[60] my-10 p-4 md:p-10 md:px-16 rounded-3xl font-helvetica relative'
            >
              <button
      ...
      >
        ...
        <div className='relative z-40 p-6 md:p-8'>
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className='text-white text-xl md:text-4xl font-semibold max-w-xs text-left [text-wrap:balance] font-helveticasans mt-1'
          >
            {card.title}
          </motion.p>
        </div>
